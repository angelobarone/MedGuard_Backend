...
class PublishedData(db.Model):
    ...
    eta_media = db.Column(db.Float, nullable=True)
    glicemia_media = db.Column(db.Float, nullable=True)
    colesterolo_media = db.Column(db.Float, nullable=True)
    prevalenza_diabete = db.Column(db.Float, nullable=True)
    percentuale_fumatori = db.Column(db.Float, nullable=True)
    percentuale_uomini = db.Column(db.Float, nullable=True)
    percentuale_femmine = db.Column(db.Float, nullable=True)

    n_nord = db.Column(db.Integer, nullable=False)
    eta_media_nord = db.Column(db.Float, nullable=True)
    glicemia_media_nord = db.Column(db.Float, nullable=True)
    colesterolo_media_nord = db.Column(db.Float, nullable=True)
    prevalenza_diabete_nord = db.Column(db.Float, nullable=True)
    percentuale_fumatori_nord = db.Column(db.Float, nullable=True)
    percentuale_uomini_nord = db.Column(db.Float, nullable=True)
    percentuale_femmine_nord = db.Column(db.Float, nullable=True)

    n_sud = db.Column(db.Integer, nullable=False)
    eta_media_sud = db.Column(db.Float, nullable=True)
    glicemia_media_sud = db.Column(db.Float, nullable=True)
    colesterolo_media_sud = db.Column(db.Float, nullable=True)
    prevalenza_diabete_sud = db.Column(db.Float, nullable=True)
    percentuale_fumatori_sud = db.Column(db.Float, nullable=True)
    percentuale_uomini_sud = db.Column(db.Float, nullable=True)
    percentuale_femmine_sud = db.Column(db.Float, nullable=True)

    n_centro = db.Column(db.Integer, nullable=False)
    eta_media_centro = db.Column(db.Float, nullable=True)
    glicemia_media_centro = db.Column(db.Float, nullable=True)
    colesterolo_media_centro = db.Column(db.Float, nullable=True)
    prevalenza_diabete_centro = db.Column(db.Float, nullable=True)
    percentuale_fumatori_centro = db.Column(db.Float, nullable=True)
    percentuale_uomini_centro = db.Column(db.Float, nullable=True)
    percentuale_femmine_centro = db.Column(db.Float, nullable=True)
